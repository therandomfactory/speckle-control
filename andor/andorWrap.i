...
/* for functions that pass data out by reference, specifically the GetImage func
tion */
...
/* Now autogenerated by andorCodeGen instead -  unsigned int GetAvailableCameras(at_32 * numCamera); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int GetCameraSerialNumber(int * number); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int GetEMAdvanced(int * state); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetEMCCDGain(int * gain); */
unsigned int GetEMGainRange(int * low, int * high);
/* Now autogenerated by andorCodeGen instead - unsigned int GetExternalTriggerTermination(at_u32 * puiTermination); */
unsigned int GetFastestRecommendedVSSpeed(int * index, float * speed);
/* Now autogenerated by andorCodeGen instead - unsigned int GetFIFOUsage(int * FIFOusage); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetFilterMode(int * mode); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetFKExposureTime(float * time); */
unsigned int GetFKVShiftSpeed(int index, int * speed);
unsigned int GetFKVShiftSpeedF(int index, float * speed);
/* Now autogenerated by andorCodeGen instead - unsigned int GetFrontEndStatus(int * piFlag); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetGateMode(int * piGatemode); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int GetImageRotate(int * iRotate); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int GetIRQ(int * IRQ); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetKeepCleanTime(float * KeepCleanTime); */
unsigned int GetMaximumBinning(int ReadMode, int HorzVert, int * MaxBinning);
/* Now autogenerated by andorCodeGen instead - unsigned int GetMaximumExposure(float * MaxExp); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetMaximumNumberRingExposureTimes(int * number); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int GetMinimumImageLength(int * MinImageLength); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetMinimumNumberInSeries(int * number); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberADChannels(int * channels); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberAmp(int * amp); */
unsigned int GetNumberAvailableImages(at_32 * first, at_32 * last);
unsigned int GetNumberDDGExternalOutputs(at_u32 * puiCount);
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberDevices(int * numDevs); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberFKVShiftSpeeds(int * number); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberHorizontalSpeeds(int * number); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberPreAmpGains(int * noGains); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberRingExposureTimes(int * ipnumTimes); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberIO(int * iNumber); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberVerticalSpeeds(int * number); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberVSAmplitudes(int * number); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetNumberVSSpeeds(int * speeds); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int GetReadOutTime(float * ReadOutTime); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int GetStartUpTime(float * time); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetStatus(int * status); */
/* Now autogenerated by andorCodeGen instead - unsigned int GetTECStatus(int * piFlag); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int GetTotalNumberImagesAcquired(at_32 * index); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int IsCoolerOn(int * iCoolerStatus); */
unsigned int IsCountConvertModeAvailable(int mode);
/* Now autogenerated by andorCodeGen instead - unsigned int IsInternalMechanicalShutter(int * InternalShutter); */
...
/* Now autogenerated by andorCodeGen instead - unsigned int Filter_GetMode(unsigned int * mode); */
unsigned int Filter_SetThreshold(float threshold);
/* Now autogenerated by andorCodeGen instead - unsigned int Filter_GetThreshold(float * threshold); */
unsigned int Filter_SetDataAveragingMode(int mode);
/* Now autogenerated by andorCodeGen instead - unsigned int Filter_GetDataAveragingMode(int * mode); */
unsigned int Filter_SetAveragingFrameCount(int frames);
/* Now autogenerated by andorCodeGen instead - unsigned int Filter_GetAveragingFrameCount(int * frames); */
unsigned int Filter_SetAveragingFactor(int averagingFactor);
/* Now autogenerated by andorCodeGen instead - unsigned int Filter_GetAveragingFactor(int * averagingFactor); */
