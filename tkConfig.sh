...
# installed.
TK_PREFIX='/home/nessi/nessi-control'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/nessi/nessi-control'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/nessi/nessi-control/tcltk/tk8.6.8/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/nessi/nessi-control/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/nessi/nessi-control/include'
...
# compiled.
TK_SRC_DIR='/home/nessi/nessi-control/tcltk/tk8.6.8'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/nessi/nessi-control/tcltk/tk8.6.8/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/nessi/nessi-control/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/nessi/nessi-control/tcltk/tk8.6.8/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/nessi/nessi-control/lib/libtkstub8.6.a'
