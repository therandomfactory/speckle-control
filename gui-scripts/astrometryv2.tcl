...
global SCOPE ACQREGION PSCALES ANDOR_CFG PI DS9 ANDOR_ARM env TELEMETRY WCSPARS
  ...
  puts $fout "CRPIX1 [expr $ACQREGION(geom)/$ANDOR_CFG(binning)]"
  puts $fout "CRPIX2 [expr $ACQREGION(geom)/$ANDOR_CFG(binning)]"
...
global ACQREGION SCOPE PSCALES ANDOR_CFG PI ANDOR_ARM env TELEMETRY WCSPARS
  ...
  set r [fitshdrrecord  CRPIX1	 	integer [expr $ACQREGION(geom)/$ANDOR_CFG(binning)]	"Coordinate reference pixel in X"]
  $fid put keyword $r
  set r [fitshdrrecord  CRPIX2	 	integer [expr $ACQREGION(geom)/$ANDOR_CFG(binning)]	"Coordinate reference pixel in Y"]
  $fid put keyword $r
